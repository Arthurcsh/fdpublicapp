package com.wondersgroup.fdpublicapp.home.modeSeller.adapter;
 ...
 *  示范商家 adapter
 */
public class FDModelSellerAdapter extends BaseAdapter {

	private Context activity;
	public ArrayList<FDRestaurant> restaurantList;
	
	public FDModelSellerAdapter(Context activity,ArrayList<FDRestaurant> restlist) {
		super();
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null) {
			convertView = LayoutInflater.from(activity).inflate(R.layout.fd_rest_main_info, null);
			TextView restNameText = (TextView) convertView.findViewById(R.id.rest_details_name_tv);
			ImageView photoImg = (ImageView) convertView.findViewById(R.id.rest_details_photo_img);
			ImageView credit_img = (ImageView) convertView.findViewById(R.id.rest_details_credit_img); 
			TextView creditText = (TextView) convertView.findViewById(R.id.rest_details_credit_tv);
			TextView supervision = (TextView) convertView.findViewById(R.id.rest_details_company_name_tv);
			TextView supervisionDate = (TextView) convertView.findViewById(R.id.rest_details_company_date_tv);
			TextView average = (TextView) convertView.findViewById(R.id.rest_details_expense_tv);
			TextView address = (TextView) convertView.findViewById(R.id.rest_details_address_tv);
			TextView telephone = (TextView) convertView.findViewById(R.id.rest_details_phone_tv);
			if(restaurantList!=null) {
				...
				address.setText(restaurant.getBizAddress());
			...
			restNameText.setOnClickListener(new OnClickListener(){
