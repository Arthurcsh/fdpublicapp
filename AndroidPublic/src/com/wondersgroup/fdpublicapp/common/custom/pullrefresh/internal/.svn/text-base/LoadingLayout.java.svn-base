...
import com.wondersgroup.fdpublicapp.common.custom.pullrefresh.PullToRefreshBase.Orientation;
	...
	public LoadingLayout(Context context, final Mode mode, final Orientation scrollDirection, TypedArray attrs) {
		...
		switch (mode) {
			case PULL_FROM_END:
				...
				mReleaseLabel = context.getString(R.string.pushmsg_center_pull_up_text);
				break;
