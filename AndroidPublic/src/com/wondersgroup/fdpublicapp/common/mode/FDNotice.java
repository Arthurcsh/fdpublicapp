...
public class FDNotice implements Serializable {
	
	public final static String UTF8 = "UTF-8";
	public final static String NODE_ROOT = "fdpublic";
	...
	public static FDNotice parse(InputStream inputStream) throws IOException, AppException {
		FDNotice notice = null;
        //获得XmlPullParser解析器
