 ...
 * @author Jeff Gilfelt
 */
public class FDBadgeView extends TextView {
	...
	private static final int DEFAULT_BADGE_COLOR = Color.parseColor("#FA6801");
	...
	public FDBadgeView(Context context) {
		this(context, (AttributeSet) null, android.R.attr.textViewStyle);
	}
	
	public FDBadgeView(Context context, AttributeSet attrs) {
     ...
     */
	public FDBadgeView(Context context, View target) {
     ...
     */
	public FDBadgeView(Context context, TabWidget target, int index) {
		this(context, null, android.R.attr.textViewStyle, target, index);
	}
	
	public FDBadgeView(Context context, AttributeSet attrs, int defStyle) {
		this(context, attrs, defStyle, null, 0);
	}
	
	public FDBadgeView(Context context, AttributeSet attrs, int defStyle, View target, int tabIndex) {
