...
//			break;
	...
	public void saveErrorLog(Exception excp) {
		...
		try {
			...
			if(storageState.equals(Environment.MEDIA_MOUNTED)){
				savePath = Environment.getExternalStorageDirectory().getAbsolutePath() + "/fdpublic/Log/";
	...
	private boolean handleException(Throwable ex) {
		...
		final String crashReport = getCrashReport(context, ex);    //显示异常信息&发送报告
		new Thread() {
			public void run() {
				Looper.prepare();
				FDUIHelper.sendAppCrashReport(context, crashReport);
				Looper.loop();
			}
	...
	private String getCrashReport(Context context, Throwable ex) {
		PackageInfo pinfo = ((FDAppContext)context.getApplicationContext()).getPackageInfo();
